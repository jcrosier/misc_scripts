...
isobar_1000 = Dataset([pressures[0]]*6, [*range(-20, 50, 10)], 'red', 'ISOBAR: P = 1000 mb', 2)
#isobar_500 = Dataset([pressures[1]]*6, [*range(-40, 30, 10)], 'blue', '500 mb', 2)
#isotherm_15 = Dataset(pressures, [15]*2, 'red', '15 degC', 3)
isotherm_n20 = Dataset(pressures, [-20]*2, 'blue', 'ISOTHERM: T = -20 degC', 3)
#entropy_15 = Dataset(pressures, [tephi.transforms.convert_pt2pT(press, 15)[1] for press in pressures], 'red', '15 degC', 4)
entropy_20 = Dataset(pressures, [tephi.transforms.convert_pt2pT(press, 20)[1] for press in pressures], 'green', 'ISENTROPE: theta = 20 degC', 4)
...
plot_list = [span_profile, standard_profile, isobar_1000, isotherm_n20, entropy_20, sonde_profile, sonde_profile_td]
#plot_tephi(plot_list, 'BLANK', [])
#plot_tephi(plot_list, 'STANDARD ATMOSPHERE', [1])
#plot_tephi(plot_list, 'ISOBARS', [2])
#plot_tephi(plot_list, 'ISO lines', [2, 3, 4])
#plot_tephi(plot_list, 'ISOTHERMS', [3])
#plot_tephi(plot_list, 'ISENTROPES', [4])
plot_tephi(plot_list, 'CAMBORNE_20240327_12Z', [5])
